...
const STARTER_FILES: Record<string, Record<string, string>> = {
  ...
  angular: {
    'package.json': JSON.stringify({
      ...
      version: '0.0.1',
      private: true,
      scripts: { dev: 'ng serve --host 0.0.0.0 --port 5173', build: 'ng build', start: 'ng serve' },
      dependencies: { '@angular/core': '^18.0.0', '@angular/common': '^18.0.0', '@angular/compiler': '^18.0.0', '@angular/platform-browser': '^18.0.0', '@angular/platform-browser-dynamic': '^18.0.0', '@angular/router': '^18.0.0', rxjs: '^7.8.0', 'zone.js': '^0.14.0', tslib: '^2.6.0' },
      devDependencies: { '@angular/cli': '^18.0.0', '@angular/compiler-cli': '^18.0.0', '@angular-devkit/build-angular': '^18.0.0', typescript: '^5.5.0' },
    }, null, 2),
    'angular.json': JSON.stringify({
      ...
      projects: {
        app: {
          ...
          architect: {
            build: { builder: '@angular-devkit/build-angular:application', options: { outputPath: 'dist', index: 'src/index.html', browser: 'src/main.ts', tsConfig: 'tsconfig.json', polyfills: ['zone.js'] } },
            serve: { builder: '@angular-devkit/build-angular:dev-server', options: { host: '0.0.0.0', port: 5173, allowedHosts: ['all'] } },
          },
        },
      },
    }, null, 2),
    'tsconfig.json': JSON.stringify({ compilerOptions: { target: 'ES2022', module: 'ES2022', moduleResolution: 'bundler', lib: ['ES2022', 'DOM'], strict: true, esModuleInterop: true, experimentalDecorators: true, forceConsistentCasingInFileNames: true, skipLibCheck: true }, angularCompilerOptions: { enableI18nLegacyMessageIdFormat: false, strictInjectionParameters: true, strictInputAccessModifiers: true, strictTemplates: true } }, null, 2),
  ...
  node: {
    'package.json': JSON.stringify({
      ...
      dependencies: { fastify: '^4.28.0', '@fastify/cors': '^9.0.0', '@fastify/swagger': '^8.15.0', '@fastify/swagger-ui': '^4.1.0' },
      devDependencies: { typescript: '^5.5.0', tsx: '^4.16.0', '@types/node': '^20.14.0' },
    }, null, 2),
    'src/server.ts': `import Fastify from 'fastify'\nimport cors from '@fastify/cors'\nimport swagger from '@fastify/swagger'\nimport swaggerUi from '@fastify/swagger-ui'\n\nconst app = Fastify({ logger: true })\n\nawait app.register(cors, { origin: true })\nawait app.register(swagger, {\n  openapi: {\n    info: { title: 'My API', version: '0.0.1' },\n  },\n})\nawait app.register(swaggerUi, { routePrefix: '/docs' })\n\napp.get('/api/hello', {\n  schema: {\n    tags: ['default'],\n    response: { 200: { type: 'object', properties: { message: { type: 'string' } } } },\n  },\n}, async () => ({ message: 'Hello from Forge AI 🔨' }))\n\nconst port = Number(process.env.PORT ?? 5173)\nawait app.listen({ host: '0.0.0.0', port })\nconsole.log(\`Server running on http://localhost:\${port}\`)\n`,
    'tsconfig.json': JSON.stringify({ compilerOptions: { target: 'ES2022', module: 'ES2022', moduleResolution: 'bundler', outDir: 'dist', strict: true, esModuleInterop: true, skipLibCheck: true }, include: ['src'] }, null, 2),
  },
  flutter: {
    'pubspec.yaml': [
      'name: my_flutter_app',
      'description: A Flutter web application built with Forge AI',
      'version: 1.0.0',
      '',
      'environment:',
      '  sdk: ">=3.4.0 <4.0.0"',
